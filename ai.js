...
const testCommandPromptStep1a = async () => {
  const query =
    "get all the breeder’s name and location. Here's the URL just in case you missed it: 'https://herefordsondemand.com/find-a-breeder-detail/84015/'";
...
const testCommandPromptStep1b = async () => {
  ...
  const prompt = buildPrompt("process-data", {
    command,
